...
{
    public partial class ChangedAllByteToInt : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Discriminator = table.Column<string>(nullable: false),
                    ISBN = table.Column<string>(maxLength: 18, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LibraryAssets_Genres_GenreId",
                        column: x => x.GenreId,
