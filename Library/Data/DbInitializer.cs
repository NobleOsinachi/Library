...
PopulateLibraryBranch(context);
PopulateLibraryCard(context);
PopulatePatron(context);
PopulateBook(context);
PopulateVideo(context);
PopulateBranchHour(context);

context.Dispose();
return;
}

private static void PopulateGenre(LibraryContext context)
{
...
private static void PopulateStatus(LibraryContext context)
{
...
private static void PopulateLibraryBranch(LibraryContext context)
{
#region Populate LibraryBranch
List<LibraryBranch> branch = new List<LibraryBranch>()
{
new LibraryBranch("88 Lakeshore Drive", "Lake Shore Branch", "+1 (800) 616 1927", new DateTime(1975,03,13),"The oldest branch in Lakeview."){ImageUrl="/images/branches/1.png" },
new LibraryBranch("123 Skyline Lane", "Mountain View Branch", "+1 (810) 555 1279", new DateTime(1998,06,01),"The Mountain View Branch contains the largest collection of nature books and encyclopedia."){ImageUrl="/images/branches/2.png"  },
new LibraryBranch("540 Inventors Circle", "Pleasant Hill Branch", "+1 900 463 8273", new DateTime(2017,09,20),"The newest Lakeview Library System Branch."){ ImageUrl="/images/branches/3.png" },
};
...
private static void PopulateLibraryCard(LibraryContext context)
{
...
private static void PopulatePatron(LibraryContext context)
{
// Use Arrays instead of List<T> to optimize performance.
#region Populate Patron
Patron[] patrons = new Patron[]
{
new Patron{FirstName = "Noble", LastName="Chukwukere", Address="Lagos", DateOfBirth = new DateTime(1998, 03, 25), TelephoneNumber = "+2349025778189", LibraryCard=new LibraryCard(8), HomeLibraryBranch=new LibraryBranch(1)},
new Patron{FirstName = "Laura", LastName="Norman", Address="San Francisco", DateOfBirth = DateTime.Parse("1997-12-25"), TelephoneNumber = "+18106506762", LibraryCard=new LibraryCard(4),HomeLibraryBranch=new LibraryBranch(2) },
...
private static void PopulateBook(LibraryContext context)
{
...
{
new Book{ Author = "Jane Austen", Cost = 18, DeweyIndex = "823.123", ImageUrl = "", ISBN = "9781519202987", Location = new LibraryBranch(1), NumberOfCopies = 3, Status = new Status(StatusId.Available), Title = "Emma", Year = 2020 },
...
new Book(13.53, new LibraryBranch(1), StatusId.Lost, "Man's Search For Meaning", 2015, "/images/books/man's-search-for-meaning.jpg", int.MaxValue, "9787734629823", "Victor E. Frankl", "845.221") { },
};
...
private static void PopulateVideo(LibraryContext context)
{
#region Populate Video
List<Video> videos = new List<Video>()
{
new Video(){Title="Blue Velvet", Cost=24, Director="David Lynch", ImageUrl="", Location=new LibraryBranch(1), NumberOfCopies=3,Status=new Status(StatusId.Available), Year=2020,},
new Video(ushort.MaxValue, new LibraryBranch(1), StatusId.Available,"The Old Guard",2020, "/images/videos/the-old-guard.jpg",13,"Gina Prince-ByTheWood"){ },
};
...
private static void PopulateBranchHour(LibraryContext context)
{
#region Populate BranchHour
List<BranchHour> branchHours = new List<BranchHour>
{
new BranchHour(new LibraryBranch(1), 14, DayOfWeek.Sunday, 7),
new BranchHour(new LibraryBranch(1), 18, DayOfWeek.Monday, 7),
new BranchHour(new LibraryBranch(1), 18, DayOfWeek.Tuesday, 7),
new BranchHour(new LibraryBranch(1), 18, DayOfWeek.Wednesday, 7),
new BranchHour(new LibraryBranch(1), 18, DayOfWeek.Thursday, 7),
new BranchHour(new LibraryBranch(1), 18, DayOfWeek.Friday, 7),
new BranchHour(new LibraryBranch(1), 14, DayOfWeek.Saturday, 7),

new BranchHour(new LibraryBranch(2), 20,DayOfWeek.Sunday, 6),
new BranchHour(new LibraryBranch(2), 20,DayOfWeek.Monday, 6),
new BranchHour(new LibraryBranch(2), 20,DayOfWeek.Tuesday, 6),
new BranchHour(new LibraryBranch(2), 20,DayOfWeek.Wednesday, 6),
new BranchHour(new LibraryBranch(2), 20,DayOfWeek.Thursday, 6),
new BranchHour(new LibraryBranch(2), 20,DayOfWeek.Friday, 6),
new BranchHour(new LibraryBranch(2), 20,DayOfWeek.Saturday, 6),

new BranchHour(new LibraryBranch(3), 22, DayOfWeek.Sunday, 5),
new BranchHour(new LibraryBranch(3), 18, DayOfWeek.Monday, 5),
new BranchHour(new LibraryBranch(3), 18, DayOfWeek.Tuesday, 5),
new BranchHour(new LibraryBranch(3), 18, DayOfWeek.Wednesday, 5),
new BranchHour(new LibraryBranch(3), 18, DayOfWeek.Thursday, 5),
new BranchHour(new LibraryBranch(3), 22, DayOfWeek.Friday, 5),
new BranchHour(new LibraryBranch(3), 22, DayOfWeek.Saturday, 5),
};
